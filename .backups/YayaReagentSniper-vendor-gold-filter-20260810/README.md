...
- catalogue v2 de 2 420 identifiants issus de `wow-tools/data/wow.sqlite3`, combinant les matières `items.is_gatherable=1` et les réactifs `profession_recipes`/`recipe_reagents` : Vanilla 442, Burning Crusade 199, Wrath 145, Cataclysm 128, Mists 172, Warlords 94, Legion 208, BfA 170, Shadowlands 242, Dragonflight 287, The War Within 189 et Midnight 144 ;
