...
- si tes auctions sont incluses dans une opportunité, un clic manuel sur le bouton les annule, puis vérifie qu’elles ont disparu avant de lancer l’achat ;
...
- avant chaque achat Reset, le bouton impose une lecture profonde ciblée complète ; la vérification reste valable dix secondes et le clic suivant relit encore les paliers Blizzard, la quantité, le coût et la cible avant `StartCommoditiesPurchase` ;
- si la profondeur change, devient incomplète ou expire, aucun achat n’est lancé et un nouveau rescan ciblé est imposé ; les auctions personnelles prises en compte sont annulées par le clic manuel dédié avant l’achat ;
