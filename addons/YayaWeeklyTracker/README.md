...
- la meme option ajoute `RF non equipe` quand un outil Resourcefulness est possede mais que l'outil porte a une autre statistique : `outil RF` dit la possession, ce token dit le port
