...
- le rang de craft d'un objet ne change pas son itemID, seulement ses bonusId, et la statistique d'un outil est tiree au hasard sur l'exemplaire : c'est pourquoi la demande porte une variante et non un simple itemID. La statistique se lit sur un bonusId du lien, `8952` pour Resourcefulness et `8953` pour Multicraft (croisement de vingt-cinq liens complets sur quatre outils, sans collision) ; une statistique sans bonusId connu n'est pas proposee du tout, et l'infobulle du bouton le dit
